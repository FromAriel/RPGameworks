...
for (const kind of ['map', 'game', 'items', 'facts', 'character-pack-manifest']) {
...
console.log('Generated map/game/items/facts/character-pack-manifest validators and TypeScript declarations from canonical schemas.');
